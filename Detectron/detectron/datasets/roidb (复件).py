...
def combined_roidb_for_training(dataset_names, proposal_files):
    ...
    def get_roidb(dataset_name, proposal_file):
        ...
        if 0:#for shanghai ltps label =3
            ...
            num_list_num = [len(num_list[0]),len(num_list[1]),len(num_list[2])]
            print(num_list_num)
            ...
            for ii,sub_else_num in enumerate(else_num):
                if sub_else_num > len(num_list[ii]):
                    up_int = math.ceil(float(sub_else_num)/len(num_list[ii]))#up get int
                    vv = num_list[ii]*1
        ...
        if 0:#for mask
            ...
            for roidb_i, roidb_list in enumerate(roidb0):
                ...
                #    aa=1
            if 1:
                num_list_num = [len(num_list[0]),len(num_list[1]),len(num_list[2]),len(num_list[3])]
                num_max = max(num_list_num)
        ...
        if 0:  #not for S5
            for roidb_i,roidb_list in enumerate(roidb0):
                try:
                    ...
                    continue
                if roidb_list['gt_classes'][0] != 0: #and roidb_list['gt_classes'][0] != 1:
                    #print('else')
